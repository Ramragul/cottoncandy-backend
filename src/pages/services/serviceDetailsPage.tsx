...
//     borderRadius="10px" 
//     w="99%"
//     h="350px"  // Explicitly setting height
//     mx="auto"  
//     overflow="hidden" 
//     boxShadow="xl"
//     cursor="pointer"
...
//         alt={`Portfolio Image ${index + 1}`}
//         w="100%"
//         h="100%"  // Ensuring the image takes full height
//         objectFit="cover"
//     />
// </Box>
...
// Version 4 : Enhancement to version 3
...
<Box 
    position="relative"
    display={{ base: "flex", md: "none" }} 
    overflow="hidden" // Hide overflow except for scrolling
    py={2} 
    px={1} 
    scrollSnapType="x mandatory"
    css={{
